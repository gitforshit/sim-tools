    ...
    def integrate(self, t, y, tf, opts):
        ...
        for i in range(self.maxsteps):
            ...
            if i==0:  # initial steps
                t_np1,y_np1 = t+h, y#self.step_EE(t,y, h)
                t_nm1,y_nm1 = t,y
            else:   
                try:
...
#            print(t)
    ...
    def step_BDF2(self,T,Y, h):
        ...
        def y_np1derfunc():
            def y_np1der(yvar):
                return (alpha[0]*yvar+alpha[1]*y_n+alpha[2]*y_nm1) / h
            return y_np1der 
        
        def Hfunc(y_np1der):
            def H(yvar):
                return F(t_np1,yvar,y_np1der(yvar))
            return H
        
        H=Hfunc(y_np1derfunc())    
...
exp_sim_2 = BDF_2(pend_mod) #Create a BDF solver
