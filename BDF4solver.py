    ...
    def integrate(self, t, y, tf, opts):
        ...
        for i in range(self.maxsteps):
            ...
            if i==0:  # initial steps
                ...
                try:
                    t_np1, y_np1 = self.step_BDF3([t,t_nm1,t_nm2,t_nm3], [y,y_nm1,y_nm2,y_nm3], h)
...
#                    reduced = True                
            ...
            if self.hrdct > 15:
                raise Explicit_ODE_Exception('Problem did not converge.')
    ...
    def step_BDF2(self,T,Y, h):
        ...
        for i in range(self.maxit):
            ...
            Dx=SL.solve(Gprime(y_np1_i),-G(y_np1_i))
